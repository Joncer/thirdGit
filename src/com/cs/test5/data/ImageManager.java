...
//			float scale = (width-20)/2/PicWidth;
//			System.out.println("scale="+scale);
//			int FinalWidth = (int)(width-20)/2;
//			int FinalHeight =(int)(PicHeight*scale);
//			System.out.println("FinalWidth = "+ FinalWidth + "FinalHeight = " + FinalHeight);
//			bitmap = mMemoryCache.get(url + FinalWidth + FinalHeight);
